        ...
        #insert if not exist 
            ...
            try:
                mycursor.execute("""insert into 
                          ...
                          VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)""",(static_ID,Facebook_ID,insta_followers,instgram_ID,Page_likes,profile_pic,Page_name,0,0,country))
            except Exception as e:
                print("eroor found on insertion", e)
